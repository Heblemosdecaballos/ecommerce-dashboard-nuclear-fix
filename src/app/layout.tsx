...
export const metadata: Metadata = {
  ...
  description: "El punto de encuentro de El Caballo Criollo Colombiano. Foros, debates, noticias y recursos ecuestres.",
  ...
  openGraph: { 
    ...
    description: "El punto de encuentro de El Caballo Criollo Colombiano",
    images: [
      {
